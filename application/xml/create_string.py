...
def create_manager_compendium_string() -> dict:
    """Algoritmul stabileste parametrii ce vor fi trimisi serverului Hattrick pentru a crea fisierul 'managercompendium'.
...
def create_matches_string(team_id: int) -> dict:
    """Algoritmul stabileste parametrii ce vor fi trimisi serverului Hattrick pentru a crea fisierul 'matches'.
...
def create_match_details_string(match_id: int) -> dict:
    """Algoritmul stabileste parametrii ce vor fi trimisi serverului Hattrick pentru a crea fisierul 'matchdetails'.
...
def create_match_orders_string(match_id: int, team_id: int) -> dict:
    """Algoritmul stabileste parametrii ce vor fi trimisi serverului Hattrick pentru a crea fisierul 'matchorders'.
